...
export class HelpWizard implements OnInit {
  ...
  private helpTips: HelpTip[] = [
    ...
    {
      path: '/pertes',
      title: '💔 المنتجات التالفة (الخسائر)',
      message: 'إذا شري كليان تيليفون وبان فيه عيب وما قدرتيش ترجعو للمورد، سجلو هنا. هاد المبلغ غادي يتنقص أوتوماتيكياً من الربح ديالك في التقرير.'
    },
    {
      path: '/credits',
